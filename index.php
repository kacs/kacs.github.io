...
<td height="0" colspan="2" valign="top" bgcolor="#F0F0F0">
  <table border="1" cellspacing="1" cellpadding="6" class="feed">
    ...
    <tr>
      <td><table border="0">
	  <tr>
	    <td width="443">Stay connected with your colleagues in the Kalamazoo ACS  Local Section by liking our Facebook page.</td>
	    <td width="92"><a href="https://www.facebook.com/ACSKalamazoo"><img src="images/facebook.png" width="27" height="27"></a></td>
	  </tr>
      </table></td>
    </tr>
    <tr>
      <td><h2>Current KACS Newsletter:</h2>
	<table width="555" border="1">
	  <tr>
		...
		KACS Chair<br>
		<img src="images/Schoffers150 copy.jpg" width="130" height="195"><br>
		Elke Schoffers, Ph.D. </p>
	    </td>
	  </tr>
	</table>
      </td>
    ...
    <tr>
      <td><p><strong>2012 KACS Awards</strong></p>
	<p>Outstanding college and high school students, our Section&rsquo;s Competitive Exam winners, a high school teacher, one ACS 50-year member and 10 past-chairs still living in the Kalamazoo area, along with parents, siblings, teachers and a few Local Section members &mdash; 91 enthusiastic guests in all &mdash; visited WMU&rsquo;s campus on May 21 to join the KACS Awards Ceremony. &nbsp;CONGRATULATIONS&nbsp; to everyone!</p>
	<p><img width="200" height="167" src="index_clip_image002_0000.png"><br>
	  Elke Schoffers (KACS Chair) congratulates Al Nieboer (Outstanding High School Chemistry Teacher, Kalamazoo Christian High School).</p>
	<p><img width="339" height="216" src="index_clip_image004.png"></p>
	<p>KACS Past-Chairs (left to right): Donald Schreiber, John Greenfield, Benjamin Maxey, Robert Kelly, Lydia Hines, Wade Adams, Robert Nagler, Doug Williams, John Stodola, James Kiddle</p>
	<p><br>
      </p></td>
    </tr>
    <tr>
      <td><p><strong>Allegan Meet 'N Greet</strong></p>
	<p><img src="Activities/2012/Allegan1_small.JPG" width="288" height="192"></p>
	<p>Did you know which element circulates in rumors of having been despised by Mahatma Gandhi? Mark Wolf did! He won the puzzle prize at the KACS Meet 'N Greet in Allegan on June 22, 2012. Congratulations!</p></td>
    </tr>
    <tr>
      <td><p>Excerpt from <strong><a href="Executive Committee/Madeleine_Jacobs.pdf">&ldquo;A Letter from Madeleine Jacobs&rdquo; </a></strong><br>
	  ACS Executive Director and Chief Executive Officer </p></td>
    </tr>
    <tr>
      <td><i><font face="Helvetica"><a href="Executive Committee/institutions.htm"><b>Where do our members work?</b></a></font></i></td>
    </tr>
  </table>
</td>
</tr>
